...
alerts-low-ammonia-name = [color=red]Low Ammonia[/color]
alerts-low-ammonia-desc = There is [color=red]not enough ammonia[/color] in the air you are breathing. Put on [color=green]internals[/color].
